...
import { onAuthStateChanged, child, get, ref, set, auth, database } from "../firebase/firebaseConfig";
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input
                                type="text"
                                name="title"
                                className="w-full p-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-400"
